...
public class ArduinoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArduinoPackage.MODULE: {
				org.gemoc.sequential.model.arduino.Module module = (org.gemoc.sequential.model.arduino.Module)theEObject;
	 ...
	 * @generated
	 */
	public T caseModule(org.gemoc.sequential.model.arduino.Module object) {
		return null;
	}
